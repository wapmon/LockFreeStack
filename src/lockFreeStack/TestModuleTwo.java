...
public class TestModuleTwo {
	...
	*/
	...
	private static AtomicReferenceArray<ThreadInfo> location;
	private static AtomicIntegerArray collision;
...
//	private static long operationTimeTotal = 0;
	...
	public static void main(String[] args) {
		...
		while(true) {    
		    try {
		        ...
		        System.out.println("Please enter an integer for the number of Threads...");
		        scanner.next();
		    }
		}
